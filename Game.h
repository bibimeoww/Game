...
private:
    ...
    void dr(float x, float y, float w, float h, sf::Color c, bool ol=false, sf::Color oc=sf::Color::White);
    void bar(float x, float y, float w, float h, float ratio, sf::Color fg, const std::string& lb="");
    void dIntro();
